import { Clause, RightObligation, DocumentCategory } from '../../src/types';
...
function getConsumerRole(category: DocumentCategory): string {
  switch (category) {
...
function summarizeRight(clause: Clause, _category: DocumentCategory): string | null {
...
function summarizeObligation(clause: Clause, _category: DocumentCategory): string | null {
  const text = clause.text;
...
function summarizeRestriction(clause: Clause, _category: DocumentCategory): string | null {
  const text = clause.text;
