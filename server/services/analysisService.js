...
import { extractRightsAndObligations } from './rightsObligationsExtractor.js';
 ...
 */
export function analyzeDocumentText(rawText, customTitle) {
 ...
 */
export function answerQuestionLocally(question, analysis) {
 ...
 */
export function compareDocumentsLocally(doc1, doc2) {
  const safetyDelta = doc2.overallRiskScore - doc1.overallRiskScore;
  const clauseDiffs = [];
  const negotiationWins = [];
