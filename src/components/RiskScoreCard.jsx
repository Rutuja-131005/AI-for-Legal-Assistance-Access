...
const RiskScoreCardComponent = ({ analysis }) => {
  ...
  const breakdown = analysis.riskBreakdown || {
    financial: 50,
    rightsProtection: 50,
    terminationFlexibility: 50,
    liabilityFairness: 50
  };
        ...
        <div className="flex items-baseline gap-3 my-2">
          ...
          <div className="ml-auto text-right">
            ...
            <span className="text-[11px] text-stone-400">
              {redFlags.length} total clauses of concern
            </span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 pt-3 border-t border-stone-100 text-xs">
        <div>
          <div className="flex justify-between text-[11px] text-stone-500 mb-1">
            ...
            <span className="font-semibold text-stone-800">{breakdown.financial}%</span>
          </div>
        ...
        <div>
          <div className="flex justify-between text-[11px] text-stone-500 mb-1">
            ...
            <span className="font-semibold text-stone-800">{breakdown.rightsProtection}%</span>
          </div>
          <div className="w-full h-1.5 bg-stone-100 rounded-full overflow-hidden">
            <div 
              className="h-full bg-stone-800 rounded-full" 
              style={{ width: `${breakdown.rightsProtection}%` }} 
            />
          </div>
        </div>
        ...
        <div>
          <div className="flex justify-between text-[11px] text-stone-500 mb-1">
            ...
            <span className="font-semibold text-stone-800">{breakdown.terminationFlexibility}%</span>
          </div>
          <div className="w-full h-1.5 bg-stone-100 rounded-full overflow-hidden">
            <div 
              className="h-full bg-stone-800 rounded-full" 
              style={{ width: `${breakdown.terminationFlexibility}%` }} 
            />
          </div>
        </div>
        ...
        <div>
          <div className="flex justify-between text-[11px] text-stone-500 mb-1">
            ...
            <span className="font-semibold text-stone-800">{breakdown.liabilityFairness}%</span>
          </div>
          <div className="w-full h-1.5 bg-stone-100 rounded-full overflow-hidden">
            <div 
              className="h-full bg-stone-800 rounded-full" 
              style={{ width: `${breakdown.liabilityFairness}%` }} 
            />
          </div>
        </div>
      </div>
